...
public class myTextGraphicsConverter implements TextGraphicsConverter {
    ...
    public String convert(String url) throws IOException, BadImageSizeException {
        ...
        //TODO Потом надо сюда вернуться
        //50-35
        // X-18   (25-18)
        ...
        double rat = newWidth * 1.0 / newHeight;
        if (maxRatio != 0 && maxRatio < rat) {
            throw new BadImageSizeException(rat, maxRatio);
        }
        ...
        TextColorSchema schema = new myTextColorSchema();
        ...
        for (int h = 0; h < newHeight; h++) {
            for (int w = 0; w < newWidth; w++) {
                ...
                for (int i = 0; i < 3; i++) {
                    stringBuilder.append(c); //запоминаем символ c, например, в двумерном массиве или как-то ещё на ваше усмотрение
                }
